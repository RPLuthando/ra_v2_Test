...
import {
  BRow, BCol,
  BTable, BAvatar, BBadge, BFormGroup, BFormSelect, BPagination, BInputGroup, BFormInput, BInputGroupAppend, BButton, BCardBody, BCardTitle, BCardSubTitle, BCard,
} from 'bootstrap-vue'
